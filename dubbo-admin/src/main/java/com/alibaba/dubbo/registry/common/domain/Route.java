...
public class Route extends Entity {
    ...
    public static final String CONDITION_RULE = "condition";

    public static final String MODULO_RULE = "modulo";
    ...
    private String divisorArgumentName;
    ...
    public String getDivisorArgumentName() {
        return divisorArgumentName;
    }

    public void setDivisorArgumentName(String divisorArgumentName) {
    ...
    public void setRule(String rule) {
        //TODO
        if (routeType.equals(MODULO_RULE)) {
            this.rule = rule;
    ...
    public URL toUrl() {
        ...
        if(routeType.equals(MODULO_RULE)){
            URL url =  URL.valueOf(Constants.ROUTE_PROTOCOL + "://" + Constants.ANYHOST_VALUE + "/" + path
                    + "?" + Constants.CATEGORY_KEY + "=" + Constants.ROUTERS_CATEGORY
                    + "&router=modulo&runtime=true&enabled=" + isEnabled() + "&priority=" + getPriority() + "&force=" + isForce() + "&dynamic=false"
                    + "&dividend=" + getDividend() + "&divisorArgumentName=" + getDivisorArgumentName()
