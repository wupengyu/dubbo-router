...
public class SyncUtils {
    ...
    public static Route url2Route(Pair<Long, URL> pair) {
        ...
        r.setRouteType(url.getParameter("router"));
        if(r.getRouteType().equals("modulo")){
            r.setForce(url.getParameter(Constants.FORCE_KEY, true));
            r.setDividend(Integer.valueOf(url.getParameter("dividend", "0")));
            r.setDivisorArgumentName(url.getParameter("divisorArgumentName"));
        }else{
